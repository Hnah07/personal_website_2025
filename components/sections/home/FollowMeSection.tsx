...
const FollowMeSection = () => {
        ...
        >
          <defs>
            <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#FF5E9F" />
  ...
  return (
    ...
    >
      <h2 className="mb-8 text-center">Follow me</h2>
      <div className="flex flex-row gap-4 justify-center">
        {socialLinks.map((link) => (
          <a
            ...
            className="relative p-6 transition-colors duration-300 hover:bg-verdigris group"
          >
